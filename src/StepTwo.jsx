function StepTwo({ register, errors, showCompanyFields }) {
  return (
    <div className="grid gap-5 md:grid-cols-2">
      ...
      <div
        className={`md:col-span-2 overflow-hidden rounded-xl border border-slate-200 bg-slate-50 p-4 transition-all duration-300 ease-in-out ${
          showCompanyFields ? 'max-h-96 opacity-100' : 'max-h-0 border-transparent opacity-0'
        }`}
        aria-hidden={!showCompanyFields}
      >
        <div className="grid gap-5 md:grid-cols-2">
          <div>
